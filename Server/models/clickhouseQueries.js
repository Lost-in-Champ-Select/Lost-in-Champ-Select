export const getBasicWinrates = (championArrayString) => {
  const query = `
    WITH
    flattened_data AS (
      SELECT
...
//! Dynamic version
export const getTenChampsStats = (championArrayString) => {
...
export const queryAllChampStats = (championArrayString) => {
